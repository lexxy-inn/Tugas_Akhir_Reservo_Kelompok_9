...
<body class="min-h-screen flex flex-col md:flex-row">
    <!-- Left side image -->
    <div class="w-full md:w-1/2 relative h-64 md:h-screen max-h-screen overflow-hidden">
    ...
    <!-- Right side form -->
    <div class="w-full md:w-1/2 flex flex-col justify-center px-6 md:px-16 text-left min-h-screen max-h-screen overflow-hidden">
        ...
        <h1 class="text-3xl md:text-4xl font-bold mb-4 text-left">Register</h1>
        <p class="mb-6 text-left">Already have an account? 
